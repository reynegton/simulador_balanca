...
extension BorderContext on BuildContext {
  ...
  Color get selectColor => _isDark
      ? Theme.of(this).colorScheme.surface.lighten()
      : Theme.of(this).colorScheme.surface.darken();

  Color get hoverMenuColor => _isDark
      ? Theme.of(this).colorScheme.surface.lighten(0.05)
      : Theme.of(this).colorScheme.surface.darken(0.05);
